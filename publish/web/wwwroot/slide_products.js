...
function _createClass(n, t, e) {
    return t && _defineProperties(n.prototype, t),
...
!function(n, t) {
        ...
        return {
            ...
            unbind: function(n, t, o) {
                e(n, t, function(t, e, i) {
                    s = s.filter(function(n) {
                        return !!(n[0] !== t || n[1] !== e || n[2] !== i || o && n[3] !== o) || (n[4](),
                        !1)
                    })
                })
            },
            dispatch: function(n, t, e) {
                ...
                return "function" == typeof CustomEvent ? i = new CustomEvent(t,{
                    bubbles: !0,
                    detail: e
                }) : (i = document.createEvent("CustomEvent")).initCustomEvent(t, !0, !1, e),
                n.dispatchEvent(i),
                i
            },
            destroy: function() {
    ...
    function Gn(n) {
        var e = n ? n.event.bus : document.createDocumentFragment()
          , i = wn();
        return n && n.event.on(u, i.destroy),
        T(i, {
            bus: e,
            on: function(n, t) {
    ...
    var Dt = "slide"
      ...
      , zt = "fade";
    function Nt(o, e, t, r) {
        var i, n = Gn(o), u = n.on, s = n.emit, c = n.bind, a = o.Components, f = o.root, l = o.options, d = l.isNavigation, p = l.updateOnMove, h = l.i18n, v = l.pagination, g = l.slideFocus, m = a.Direction.resolve, y = K(r, "style"), b = K(r, Vn), w = -1 < t, E = A(r, "." + ft), S = tn(r, l.focusableNodes || "");
        function x() {
    ...
    var Bt = Object.freeze({
        ...
        Media: function(i, n, o) {
            ...
            function f() {
                ...
                I(o),
                l(e),
                o.destroy ? i.destroy("completely" === o.destroy) : n ? (c(!0),
                i.mount()) : t !== o.direction && i.refresh()
            }
            function l(n, t) {
                O(o, n),
        ...
        Elements: function(n, t, e) {
            ...
            return T(l, {
                ...
                mount: function() {
                    ...
                    s(Mn, v),
                    s(zn, m),
                    c(document, kt + " keydown", function(n) {
                        r = "keydown" === n.type
                    }, {
                        capture: !0
                    }),
        ...
        Slides: function(i, o, r) {
            ...
            return {
                ...
                add: function(n, o) {
                    y(n, function(n) {
                        var t, e, i;
                        g(n = M(n) ? Z(n) : n) && ((t = c[o]) ? k(n, t) : P(a, n),
                        C(n, r.classes.slide),
                        n = n,
                        e = D(u, Nn),
                        n = tn(n, "img"),
        ...
        Layout: function(n, t, e) {
            var i, o, r = (c = Gn(n)).on, u = c.bind, s = c.emit, c = t.Slides, a = t.Direction.resolve, f = (t = t.Elements).root, l = t.track, d = t.list, p = c.getAt, h = c.style;
            function v() {
                o = null,
                i = e.direction === Yn,
            ...
            function g() {
                ...
                o && o.width === n.width && o.height === n.height || (Y(l, "height", function() {
                    var n = "";
                    i && (sn(n = y(), "height or heightRatio is missing."),
                    n = "calc(" + n + " - " + m(!1) + " - " + m(!0) + ")");
                    return n
                }()),
                h(a("marginRight"), rn(e.gap)),
                h("width", e.autoWidth ? null : rn(e.fixedWidth) || (i ? "" : b())),
                h("height", rn(e.fixedHeight) || (i ? e.autoHeight ? null : b() : y()), !0),
                o = n,
                s(Tn))
            }
            function m(n) {
        ...
        Clones: function(s, e, c) {
            ...
            function h() {
                var n, t = c.clones;
                return s.is(Mt) ? t || (t = (n = c[r("fixedWidth")] && e.Layout.slideSize(0)) && ln(Q(a.track)[r("width")] / n) || c[r("autoWidth")] && s.length || 2 * c.perPage) : t = 0,
                t
            }
            return {
                mount: function() {
        ...
        Move: function(i, s, o) {
            var u, n = Gn(i), t = n.on, c = n.emit, a = i.state.set, r = (n = s.Layout).slideSize, e = n.getPadding, f = n.totalSize, l = n.listSize, d = n.sliderSize, p = (n = s.Direction).resolve, h = n.orient, v = (n = s.Elements).list, g = n.track;
            function m() {
                s.Controller.isBusy() || (s.Scroll.cancel(),
                y(i.index),
                s.Slides.update())
            }
            function y(n) {
            ...
            function x(n, t) {
                var e = h(f(n - 1) - (e = n,
                "center" === (n = o.focus) ? (l() - r(e, !0)) / 2 : +n * r(e) || 0));
                return t ? function(n) {
            ...
            return {
                ...
                move: function(n, t, e, i) {
                    ...
                    n !== t && (o = e < n,
                    r = h(w(_(), o)),
                    o ? 0 <= r : r <= v[p("scrollWidth")] - Q(g)[p("width")]) && (E(),
                    b(w(_(), e < n), !0)),
                    a(R),
                    c(Sn, t, e, n),
                    u.start(t, function() {
        ...
        Controller: function(r, o, u) {
            var s, i, c, n = Gn(r).on, a = o.Move, f = a.getPosition, l = a.getLimit, d = a.toPosition, t = o.Slides, p = t.isEnough, e = t.getLength, h = r.is(Mt), v = r.is(Dt), g = D(E, !1), m = D(E, !0), y = u.start || 0, b = y;
            function w() {
                s = e(!0),
                i = u.perMove,
                c = u.perPage;
            ...
            function S(n, t, e) {
                ...
                (o = function(n) {
                    if (v && "move" === u.trimSpace && n !== y)
                        for (var t = f(); t === d(n, !0) && hn(n, 0, r.length - 1, !u.rewind); )
                            n < y ? --n : ++n;
                    return n
                }(n)) !== n && (t = n,
                n = o,
                e = !1),
                n < 0 || i < n ? n = hn(0, n, t, !0) || hn(i, t, n, !0) ? C(P(n)) : h ? e ? n < 0 ? -(s % c || c) : s : n : u.rewind ? n < 0 ? i : 0 : -1 : e && n !== t && (n = C(P(t) + (n < t ? -1 : 1)))) : n = -1,
                n
            }
            function x(n) {
                return h ? (n + s) % s || 0 : n
                ...
                go: function(n, t, e) {
                    ...
                    A() || -1 < (n = x(i = function(n) {
                        var t = y;
                        {
                            ...
                            e = i[1],
                            i = i[2],
                            "+" === e || "-" === e ? t = S(y + +("" + e + (+i || 1)), y) : ">" === e ? t = i ? C(+i) : g(!0) : "<" === e && (t = m(!0))) : t = h ? n : vn(n, 0, _())
                        }
                        return t
                    }(n))) && (t || n !== y) && (k(n),
                    a.move(i, n, b, e))
        ...
        Arrows: function(o, n, t) {
            var e, i, r = Gn(o), u = r.on, s = r.bind, c = r.emit, a = t.classes, f = t.i18n, l = n.Elements, d = n.Controller, p = l.arrows, h = l.track, v = p, g = l.prev, m = l.next, y = {};
            function b() {
                !function() {
                    var n = t.arrows;
                    !n || g && m || (v = p || H("div", a.arrows),
                    g = x(!0),
                    m = x(!1),
                    e = !0,
                    P(v, [g, m]),
        ...
        Autoplay: function(n, t, e) {
            ...
            }), f = a.isPaused, l = t.Elements, d = (n = t.Elements).root, p = n.toggle, h = e.autoplay, v = "pause" === h;
            function g() {
                f() && t.Slides.isEnough() && (a.start(!e.resetProgress),
                o = i = v = !1,
                b(),
                c(jn))
            }
        ...
        Scroll: function(r, s, u) {
            var c, a, n = Gn(r), t = n.on, f = n.emit, l = r.state.set, d = s.Move, p = d.getPosition, h = d.getLimit, v = d.exceededLimit, g = d.translate, m = 1;
            function y(n, t, e, i, o) {
                var r = p();
                E(),
                e && (e = s.Layout.sliderSize(),
            ...
            function w(n, t, e, i) {
                var o = p()
                  , n = (n + (t - n) * (n = i,
                (i = u.easingFunc) ? i(n) : 1 - Math.pow(1 - n, 4)) - o) * m;
                g(o + n),
                r.is(Dt) && !e && v() && (m *= .6,
                dn(n) < 10 && y(h(v(!0)), 600, !1, a, !0))
            }
            function E() {
                c && c.cancel()
            }
        ...
        Drag: function(r, i, u) {
            var s, t, o, c, a, f, l, d, n = Gn(r), e = n.on, p = n.emit, h = n.bind, v = n.unbind, g = r.state, m = i.Move, y = i.Scroll, b = i.Controller, w = i.Elements.track, E = i.Media.reduce, S = (n = i.Direction).resolve, x = n.orient, _ = m.getPosition, C = m.exceededLimit, P = !1;
            function k() {
                var n = u.drag;
                j(!n),
                c = "free" === n
            ...
            function L(n) {
                ...
                e = n.target,
                i = u.noDrag,
                B(e, "." + gt + ", ." + dt) || i && B(e, i) || !t && n.button || (b.isBusy() ? $(n, !0) : (d = t ? w : window,
                a = g.is([R, W]),
                o = null,
                h(d, Lt, A, Ot),
                h(d, At, D, Ot),
            ...
            function A(n) {
                ...
                g.is(6) || (g.set(6),
                p("drag")),
                n.cancelable && (a ? (m.translate(s + N(n) / (P && r.is(Dt) ? 5 : 1)),
                e = 200 < T(n),
                i = P !== (P = C()),
                (e || i) && z(n),
                f = !0,
                p("dragging"),
                $(n)) : dn(N(o = n)) > dn(N(o, !0)) && (t = n,
            ...
            function D(n) {
                ...
                a && (function(n) {
                    ...
                    E(!1),
                    c ? b.scroll(e, 0, u.snap) : r.is(zt) ? b.go(x(gn(t)) < 0 ? n ? "<" : "-" : n ? ">" : "+") : r.is(Dt) && P && n ? b.go(C(!0) ? ">" : "<") : b.go(b.toDest(e), !0);
                    E(!0)
                }(n),
                $(n)),
                v(d, Lt, A),
            ...
            function l() {
                ...
                n.Slides.forEach(function(i) {
                    tn(i.slide, Gt).forEach(function(n) {
                        var t = K(n, Rt)
                          , e = K(n, Wt);
                        t === n.src && e === n.srcset || (t = o.classes.spinner,
        ...
        Pagination: function(f, n, l) {
            var d, p, t = Gn(f), e = t.on, i = t.emit, h = t.bind, v = n.Slides, g = n.Elements, o = n.Controller, m = o.hasFocus, r = o.getIndex, u = o.go, s = n.Direction.resolve, y = [];
            function c() {
                d && (V(g.pagination ? _(d.children) : d),
                en(d, p),
                x(y),
                d = null),
                t.destroy()
            ...
            return {
                ...
                mount: function n() {
                    c(),
                    e([zn, Mn], n),
                    l.pagination && v.isEnough() && (e([Sn, On, In], S),
                    function() {
                        var n = f.length
                          , t = l.classes
                          , e = l.i18n
                          , i = l.perPage
                          , o = m() ? n : ln(n / i);
                        C(d = g.pagination || H("ul", t.pagination, g.track.parentElement), p = vt + "--" + E()),
                        j(d, qn, "tablist"),
                        j(d, Vn, e.select),
        ...
        Wheel: function(u, s, c) {
            ...
            function t(n) {
                ...
                a = e),
                r = r,
                c.releaseWheel && !u.state.is(R) && -1 === s.Controller.getAdjacent(r) || $(n))
            }
            return {
                mount: function() {
    ...
    function qt(r, n, u) {
        var s, t = Gn(r).bind, c = n.Move, a = n.Controller, f = n.Scroll, e = n.Elements.list, l = D(Y, e, "transition");
        function i() {
            l(""),
            f.cancel()
        }
        return {
            ...
            start: function(n, t) {
                ...
                1 <= dn(e - i) && 1 <= o ? u.useScroll ? f.scroll(e, o, !1, t) : (l("transform " + o + "ms " + u.easing),
                c.translate(e, !0),
                s = t) : (c.jump(n),
                t())
            },
    ...
    a = function() {
        ...
        return n.mount = function(n, t) {
            var e = this
              , i = this.state
              , o = this.Components;
            return sn(i.is([1, 7]), "Already mounted!"),
            i.set(1),
            this._C = o,
        ...
        n.emit = function(n) {
            var t;
            return (t = this.event).emit.apply(t, [n].concat(_(arguments, 1))),
            this
        }
        ,
        n.add = function(n, t) {
